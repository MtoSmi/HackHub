...
public class UserValidator implements Validator<User> {
     ...
     * <ul>
     *   <li>L'utente non deve essere {@code null}</li>
     *   <li>Il nome non deve essere {@code null} né vuoto</li>
     *   <li>Il cognome non deve essere {@code null} né vuoto</li>
     *   <li>L'email non deve essere {@code null}, vuota e deve contenere il carattere {@code @}</li>
     *   <li>La password non deve essere {@code null} né vuota</li>
     * </ul>
     *
